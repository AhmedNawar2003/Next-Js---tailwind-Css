  ...
  return (
    <div className="flex flex-col items-center justify-center w-3/4 rounded p-4 bg-gray-200 mb-7 md:w:2/4 lg:w-1/4">
      ...
      <div className="mt-6 text-center">
        ...
        <div className="flex items-center text-green-700 mb-1 ps-3">
          <TiTick /> 100 Weekly Backups
        </div>
        <div className="flex items-center text-green-700 mb-1 ps-3">
          <TiTick /> 100 Unlimited Bandwidth
        </div>
        <div className="flex items-center text-green-700 mb-1 ps-3">
          <TiTick /> 100 Free SLL
        </div>
        <div className="flex items-center text-green-700 mb-1 ps-3">
          <TiTick /> 100 Free Email
        </div>
      </div>
      <button className=" mt-4 border-2 border-gray-900 text-2xl p-1 rounded-full hover:text-white hover:bg-gray-900 transition-all w-full">
       BUY NOW
    </button>
    </div>
